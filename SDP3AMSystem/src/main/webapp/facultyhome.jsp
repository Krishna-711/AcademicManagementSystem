...
<ul>
   <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="viewemp">Profile</a>
      <a href="#">Update</a>
      <a href="echangepwd">ChangePassword</a>
    </div>
  </div>
  <li><a href="viewfacultycourses">Courses</a></li>

  
</ul>
<a href ="facultylogin"><button class="dropbtn">Logout
    </button></a>
...
<h2 class="alignleft" >Welcome&nbsp;:-&nbsp;&nbsp;&nbsp;<c:out value="${eid}"></c:out></h2>
