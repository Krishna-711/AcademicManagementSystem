...
<form:form action="addcourses" method="post" modelAttribute="course">
<h3 style="color:white;font-weight: bold">Add Course</h3>
...
<td>
<form:input path="code" required="required"></form:input>
</td>
</tr>
...
<tr>
<td><label>L-T-P-S</label></td>
<td>
<form:input path="ltps" required="required"></form:input>
</td>
</tr>
...
<tr>
<td><label>Study Sem</label></td>
<td>
<form:input path="sem" required="required"></form:input>
</td>
</tr>
...
<tr>
<td><label>Offered By Faculty</label></td>
<td>
